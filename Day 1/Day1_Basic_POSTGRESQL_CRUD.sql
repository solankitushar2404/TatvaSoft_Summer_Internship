...
SELECT last_name, first_name FROM customer WHERE first_name = 'David';

SELECT customer_id, first_name, last_name FROM customer WHERE first_name = 'David' AND last_name = 'Warner';

SELECT customer_id, first_name, last_name FROM customer WHERE first_name IN ('Hiren', 'David', 'Bansi');
...
UPDATE customer
SET first_name = 'Tushar', last_name = 'Solanki', email = 'solankitusharramjibhai@gmail.com'
WHERE customer_id = 1;
